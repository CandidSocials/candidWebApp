...
export function LandingPage() {
  ...
  return (
    <div className="font-poppins font-normal  w-full px-0 lg:px-8 items-center flex flex-col">
      ...
      <img src="\LandingPage\hero-bg.webp" className=' hidden md:absolute w-full object-contain z-[-10] ' />
      ...
      {/* How it works */}
        <div className='flex flex-col w-full mx-4 md:mx-24 items-center justify-center mb-12 lg:mb-40'>
          <div className='flex flex-col gap-8 lg:gap-12 px-2 md:px-12 w-full shadow-lg mb-4 md:w-[50%] lg:w-[40%] xl:w-[35%] md:absolute left-0 2xl:left-24 bg-white z-10 py-12 rounded-2xl'>
            ...
            <div className='flex flex-col md:flex-row gap-4 items-left md:items-center'>
              <img src="\LandingPage\num-1.webp" className='w-8 h-8 md:w-12 md:h-12' />
          ...
          <img src="\LandingPage\how-it-works.webp" className='hidden md:block w-full md:w-[85%] h-[80vh] md:h-screen object-cover rounded-lg object-center' />
          <img src="\LandingPage\how-it-works-mobile.webp" className='block md:hidden w-full md:w-[85%] h-[80vh] md:h-screen object-cover rounded-lg object-center' />
        </div>
        ...
        <img src="src\static\LandingPage\hero-bg.png" className=' left-0 hidden md:absolute w-full h-auto object-contain overflow-hidden z-[-10] ' />
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 text-[#222325]">
            <div>
              <img src="\LandingPage\check.webp" className="w-4 h-4" />
          ...
          <div className='w-full'>
            <img className='w-full' src="\LandingPage\landing-1.webp" />
          </div>
        ...
        <div className='w-full flex flex-col mt-12 mb-12 gap-2 lg:gap-12 bg-white rounded-xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full gap-12 lg:gap-32 justify-center items-center'>
            ...
            <div className='flex flex-col gap-6'>
              <img src="\LandingPage\char-1.webp" className='w-12 h-12'/>
            ...
            {/* Number 2 */}
            <div className='flex flex-col gap-6'>
              <img src="\LandingPage\char-2.webp" className='w-12 h-12'/>
              <h3 className="text-[#404145]">
            ...
            {/* Number 3 */}
            <div className='flex flex-col gap-6'>
              <img src="\LandingPage\char-3.webp" className='w-12 h-12'/>
              <h3 className="text-[#404145]">
            ...
            {/* Number 4 */}
            <div className='flex flex-col gap-6'>
              <img src="\LandingPage\char-4.webp" className='w-12 h-12'/>
              <h3 className="text-[#404145]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-fit  mb-12 rounded-full w-full gap-6 lg:gap-0">
          <div className="relative bg-cover h-full bg-center bg-no-repeat object-left overflow-hidden rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl lg:rounded-br-none lg:rounded-tr-none lg:rounded-tl-xl " style={{ backgroundImage: "url('\\/LandingPage\\/CTA-1.webp')" }}>
          ...
          <div className="bg-white  flex items-center justify-center">
            <img className="object-cover w-full  overflow-hidden" src="\LandingPage\CTA-2.webp" />
          </div>
        </div>
      </div>
  );
